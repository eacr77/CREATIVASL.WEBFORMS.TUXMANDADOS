var FormElements = function() {"use strict";
	...
	var runInputLimiter = function() {
		$('.limited').inputlimiter({
			remText: 'Dispone de %n caracteres...',
			remFullText: 'No tiene permitidos m&aacute;s caracteres.',
			limitText: 'Tiene permitidos %n caracteres en este campo.'
		});
	};
	...
	var runTimePicker = function() {
	    $('.time-picker').timepicker({ timeFormat: 'HH:mm:ss' });
	};
